...
--
-- Hôte : 127.0.0.1
-- Généré le : lun. 01 juin 2026 à 18:44
...
--
-- Base de données : `projet_web_noellie_angel_amr`
--
...
CREATE TABLE `chat_messages` (
  ...
  `session_nickname` varchar(100) NOT NULL,
...
--
ALTER TABLE `connection_logs`
  ADD CONSTRAINT `connection_logs_ibfk_1` FOREIGN KEY (`user_id`) REFERENCES `users` (`id`);
...
--
ALTER TABLE `posts`
  ADD CONSTRAINT `posts_ibfk_1` FOREIGN KEY (`author_user_id`) REFERENCES `users` (`id`);
